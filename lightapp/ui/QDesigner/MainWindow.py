...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_csv = QtGui.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/img/csv.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_csv.setIcon(icon3)
        self.action_csv.setText(QtGui.QApplication.translate("MainWindow", "&Csv...", None, QtGui.QApplication.UnicodeUTF8))
        self.action_csv.setObjectName(_fromUtf8("action_csv"))
        self.action_pdf = QtGui.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/img/pdf.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_pdf.setIcon(icon4)
        self.action_pdf.setText(QtGui.QApplication.translate("MainWindow", "&Pdf...", None, QtGui.QApplication.UnicodeUTF8))
        self.action_pdf.setObjectName(_fromUtf8("action_pdf"))
        self.action_html = QtGui.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/img/html.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.menu_Export.addAction(self.action_csv)
